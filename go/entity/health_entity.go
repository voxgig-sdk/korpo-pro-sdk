...
func NewHealthEntity(client *core.KorpoProSDK, entopts map[string]any) *HealthEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *HealthEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *HealthEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// HealthListMatch and returns []Health. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *HealthEntity) ListTyped(reqmatch HealthListMatch, ctrl map[string]any) ([]Health, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Health](res), nil
}
