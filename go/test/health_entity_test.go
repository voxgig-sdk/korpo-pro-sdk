...
func TestHealthEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set KORPOPRO_TEST_HEALTH_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func healthBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("KORPOPRO_TEST_HEALTH_ENTID")
	...
	idmapResolved := core.ToMapAny(env["KORPOPRO_TEST_HEALTH_ENTID"])
