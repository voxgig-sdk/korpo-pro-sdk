...
describe("HealthDirect", function()
  it("should direct-list-health", function()
    local setup = health_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-health", setup.live and "live" or "unit")
