...
describe("HealthEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set KORPO_PRO_TEST_HEALTH_ENTID JSON to run live")
      return
    end
...
function health_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("KORPO_PRO_TEST_HEALTH_ENTID")
  ...
  if env["KORPO_PRO_TEST_LIVE"] == "TRUE" then
