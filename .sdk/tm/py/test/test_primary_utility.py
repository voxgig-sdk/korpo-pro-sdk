...
from projectname_sdk import KorpoProSDK
from projectname_sdk.core.spec import KorpoProSpec
from projectname_sdk.core.result import KorpoProResult
from projectname_sdk.core.response import KorpoProResponse
from projectname_sdk.core.operation import KorpoProOperation
from projectname_sdk.core.error import KorpoProError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import KorpoProBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = KorpoProSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = KorpoProSDK.test(None, None)
        ...
        class TestInitFeature(KorpoProBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(KorpoProBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = KorpoProSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = KorpoProSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = KorpoProSDK.test(None, setup_opts)
