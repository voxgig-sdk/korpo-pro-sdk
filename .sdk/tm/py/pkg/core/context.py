...
from projectname_sdk.core.control import KorpoProControl
...
class KorpoProContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, KorpoProResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, KorpoProResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return KorpoProError(code, msg, self)
