...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = KorpoProOmni.make_runner(TEST_JSON_FILE, KorpoProSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : KorpoProOmni.errify(err)
    end
