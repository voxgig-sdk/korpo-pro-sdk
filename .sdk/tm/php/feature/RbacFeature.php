...
class KorpoProRbacFeature extends KorpoProBaseFeature
{
    ...
    private function _required(KorpoProContext $ctx): ?string
    {
    ...
    private function _reject(KorpoProContext $ctx, string $required): void
    {
    ...
    private function _track(KorpoProContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
