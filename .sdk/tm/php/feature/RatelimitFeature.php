...
// KorpoPro SDK ratelimit feature
...
class KorpoProRatelimitFeature extends KorpoProBaseFeature
{
    ...
    private function _acquire(KorpoProContext $ctx): void
    {
    ...
    private function _track(KorpoProContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
