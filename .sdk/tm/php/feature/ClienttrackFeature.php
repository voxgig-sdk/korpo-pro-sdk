...
// KorpoPro SDK clienttrack feature
...
class KorpoProClienttrackFeature extends KorpoProBaseFeature
{
    ...
    public function PostConstruct(KorpoProContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'KorpoPro-SDK';
