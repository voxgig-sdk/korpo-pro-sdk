...
// KorpoPro SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class KorpoProTestFeature extends KorpoProBaseFeature
{
    ...
    public function init(KorpoProContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (KorpoProContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (KorpoProContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(KorpoProContext $ctx, $op, $args): array
    {
