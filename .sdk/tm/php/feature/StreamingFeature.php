...
// KorpoPro SDK streaming feature
...
class KorpoProStreamingFeature extends KorpoProBaseFeature
{
    ...
    private function _iterate(KorpoProResult $result): \Generator
    {
    ...
    private function _streamable(KorpoProContext $ctx): bool
    {
