...
// KorpoPro SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class KorpoProMakeRequest
{
    public static function call(KorpoProContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new KorpoProResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new KorpoProResponse($fetched);
        } else {
