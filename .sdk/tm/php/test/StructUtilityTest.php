...
// KorpoPro SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = KorpoProOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(KorpoProOmni::structfix($now, Struct::undef()))
                        !== json_encode(KorpoProOmni::structfix($val, Struct::undef()))) {
