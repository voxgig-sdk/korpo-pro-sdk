...
|---|---|---|
| `ts/` | @voxgig-sdk/korpo-pro-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/korpo-pro-sdk \
      --repository voxgig-sdk/korpo-pro-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/korpo-pro-sdk` shows it, and
`npm trust revoke @voxgig-sdk/korpo-pro-sdk --id=<id>` removes it.
