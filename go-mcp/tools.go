...
type Args struct {
	Entity string         `json:"entity" jsonschema:"health"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.KorpoProSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "korpo-pro_list",
		Description: "List records from KorpoPro. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "korpo-pro_load",
		Description: "Load a single record from KorpoPro. " +
...
func runOp(client *sdk.KorpoProSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.KorpoProSDK, name string) (sdk.KorpoProEntity, error) {
