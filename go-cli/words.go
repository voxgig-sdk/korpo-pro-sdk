...
func registerSDKWords(r *eng.Registry, client *sdk.KorpoProSDK) {
...
func runOp(client *sdk.KorpoProSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
