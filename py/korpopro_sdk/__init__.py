...
from korpopro_sdk.utility import register

# Load features
from korpopro_sdk.feature.base_feature import KorpoProBaseFeature
from korpopro_sdk.features import _has_feature, _make_feature
...
class KorpoProSDK:
    ...
    def get_utility(self):
        return KorpoProUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("KorpoProSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Health(self, data=None) -> "HealthEntity":
        ...
        from korpopro_sdk.entity.health_entity import HealthEntity
        return HealthEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "KorpoProSDK":
        if sdkopts is None:
            sdkopts = {}
