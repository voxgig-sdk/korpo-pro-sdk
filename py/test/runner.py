...
class KorpoProTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = KorpoProTestRunner.getenv("KORPOPRO_TEST_LIVE")
        override = KorpoProTestRunner.getenv("KORPOPRO_TEST_OVERRIDE")
        ...
        explain = KorpoProTestRunner.getenv("KORPOPRO_TEST_EXPLAIN")
