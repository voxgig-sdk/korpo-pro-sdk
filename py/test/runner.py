...
class KorpoProTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = KorpoProTestRunner.getenv("KORPO_PRO_TEST_LIVE")
        override = KorpoProTestRunner.getenv("KORPO_PRO_TEST_OVERRIDE")
        ...
        explain = KorpoProTestRunner.getenv("KORPO_PRO_TEST_EXPLAIN")
