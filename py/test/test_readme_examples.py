# KorpoPro SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions KorpoProSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both KorpoProSDK(...) and KorpoProSDK.test(...) become
#      KorpoProSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "korpopro_sdk"
_SDK_CLASS = "KorpoProSDK"
