...
function envOverride(m) {
    if ('TRUE' === process.env.KORPO_PRO_TEST_LIVE ||
        'TRUE' === process.env.KORPO_PRO_TEST_OVERRIDE) {
    ...
    m.KORPO_PRO_TEST_EXPLAIN = process.env.KORPO_PRO_TEST_EXPLAIN || m.KORPO_PRO_TEST_EXPLAIN;
    return m;
}
