...
// KorpoPro SDK utility: fetcher

class KorpoProFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; KorpoProSDK/1.0)';
    ...
    public static function call(KorpoProContext $ctx, string $fullurl, array $fetchdef): array
    {
