...
class KorpoProGraphql
{
    ...
    // equivalent.
    public static function body(KorpoProContext $ctx): mixed
    {
    ...
    public static function errors(KorpoProContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
