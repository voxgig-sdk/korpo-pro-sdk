...
// KorpoPro SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (KorpoProSDK::test)
...
{
    private const SDK_CLASS = 'KorpoProSDK';
    ...
    private const SDK_BASE = 'korpopro_sdk';
