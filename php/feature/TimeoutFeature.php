...
class KorpoProTimeoutFeature extends KorpoProBaseFeature
{
    ...
    private function _with_timeout(KorpoProContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(KorpoProContext $_ctx, float $ms): void
    {
        $client = $this->client;
