...
class KorpoProCacheFeature extends KorpoProBaseFeature
{
    ...
    private function _through(KorpoProContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
