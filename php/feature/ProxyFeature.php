...
class KorpoProProxyFeature extends KorpoProBaseFeature
{
    ...
    public function init(KorpoProContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (KorpoProContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
